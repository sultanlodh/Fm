from Fm_consumer import KafkaConsumer  # Ensure this matches the actual class name
import Fm_configs as conf
...
try:
    ...
    kafkaConsumer = KafkaConsumer(consumer_settings, topic, dest_connection, source_connection, Consignment_Final_Schema, Booking_Details_Final_Schema, Payment_Details_Final_Schema, Adress_Details_Final_Schema, Consignment_History_Final_Schema)
